...
class ThreadgabPollHistory
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Threadgab\Bundle\DatabaseBundle\Entity\ThreadgabPollAnswers")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToOne(targetEntity="Threadgab\Bundle\DatabaseBundle\Entity\ThreadgabPoll")
     * @ORM\JoinColumns({
